...
(def ^:private physical-object-uid 1)
(def ^:private role-uid 2)
(def ^:private aspect-uid 3)
(def ^:private relation-uid 4)
(def ^:private occurrence-uid 5)
