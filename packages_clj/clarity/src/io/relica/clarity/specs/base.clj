(ns io.relica.clarity.specs.base
...
(comment
  ...
  (expound/expound :io.relica.clarity.specs.base/entity some-entity)
  ...
  (expound/expound :io.relica.clarity.specs.base/entity some-other-entity)
