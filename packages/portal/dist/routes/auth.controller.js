...
let AuthController = class AuthController {
    ...
    async authenticateWebSocket(user) {
        try {
...
__decorate([
    (0, common_1.Post)('websocket'),
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate for WebSocket connections' }),
...
], AuthController.prototype, "authenticateWebSocket", null);
