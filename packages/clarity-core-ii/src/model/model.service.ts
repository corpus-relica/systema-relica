...
export class ModelService {
  ...
  async retrieveModelsSequentially(uids) {
    // const models = [];
  ...
  async updateDefinition(fact_uid, partial_definition, full_definition) {
    // const response = await submitDefinition(fact_uid, partial_definition, full_definition);
  ...
  async updateCollection(fact_uid, collection_uid, collection_name) {
    // const response = await submitCollection(fact_uid, collection_uid, collection_name);
    // return response;
  }
}
