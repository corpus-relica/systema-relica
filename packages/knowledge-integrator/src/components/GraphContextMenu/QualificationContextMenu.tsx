...
interface QualificationContextMenuProps {
  setUidToDelete: (uid: number) => void;
  setWarnIsOpen: (isOpen: boolean) => void;
}

const QualificationContextMenu: React.FC<QualificationContextMenuProps> =
  observer(({ setUidToDelete, setWarnIsOpen }) => {
...
export default QualificationContextMenu;
