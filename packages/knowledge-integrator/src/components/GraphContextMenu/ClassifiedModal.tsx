...
const ClassifiedModal: React.FC<ClassifiedModalProps> = ({
  uid,
  classified,
  existingSubtypes,
  handleClose,
  ...
  console.log("ClassifiedModal: uid", uid);
  ...
  // const classifiedElems = alphaSortedObjs.map((fact) => {
  //   const { lh_object_uid, lh_object_name } = fact;
