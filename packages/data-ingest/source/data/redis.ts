...
export const updateDescendantsInDB = async (nodeToDescendants: any) => {
...
export const addToSubtypesCache = async (
	nodeUid: number,
	subtypeUid: number,
) => {
	try {
		...
		console.error(
			`addToSubtypesCache:Failed to update descendants for node ${nodeUid}:`,
			error,
		);
	}
};

export const removeFromSubtypesCache = async (
	nodeUid: number,
	subtypeUid: number,
) => {
	try {
		...
		console.error(
			`removeFromSubtypesCache:Failed to update descendants for node ${nodeUid}:`,
			error,
		);
	}
};
...
export const addToEntityFactsCache = async (
	entityUid: number,
	factUid: number,
) => {
	try {
...
export const addToEntityLineageCache = async (
	entityUid: number,
	lineage: number[],
) => {
...
export const setMinFreeEntityUID = async (uid: number) => {
	const minFreeEntityUIDKey = `rlc:db:YYYY:minFreeEntityUID`;
...
export const setMinFreeFactUID = async (uid: number) => {
	const minFreeFactUIDKey = `rlc:db:YYYY:minFreeFactUID`;
