...
export declare const updateDescendantsInDB: (nodeToDescendants: any) => Promise<void>;
export declare const addToSubtypesCache: (nodeUid: number, subtypeUid: number) => Promise<void>;
export declare const removeFromSubtypesCache: (nodeUid: number, subtypeUid: number) => Promise<void>;
export declare const clearEntityFactsCacheComplete: () => Promise<void>;
export declare const addToEntityFactsCache: (entityUid: number, factUid: number) => Promise<void>;
export declare const clearEntityLineageCacheComplete: () => Promise<void>;
export declare const addToEntityLineageCache: (entityUid: number, lineage: number[]) => Promise<void>;
export declare const getMinFreeEntityUID: () => Promise<number>;
export declare const setMinFreeEntityUID: (uid: number) => Promise<void>;
export declare const getMinFreeFactUID: () => Promise<number>;
export declare const setMinFreeFactUID: (uid: number) => Promise<void>;
