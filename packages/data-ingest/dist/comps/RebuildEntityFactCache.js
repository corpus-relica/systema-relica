...
import { clearEntityFactsCacheComplete, addToEntityFactsCache, } from '../data/redis.js';
...
const RebuildEntityFactCache = ({ next }) => {
    ...
    return (React.createElement(Box, { flexDirection: "column", flexGrow: 1 },
        React.createElement(Text, null, "RebuildEntityFactCache"),
