...
export type LoadSpecializationHierarchyRequest = z.infer<typeof LoadSpecializationHierarchyRequestSchema>;
...
export type LoadAllRelatedFactsRequest = z.infer<typeof LoadAllRelatedFactsRequestSchema>;
export type LoadSubtypesConeRequest = z.infer<typeof LoadSubtypesConeRequestSchema>;
export type UnloadEntityRequest = z.infer<typeof UnloadEntityRequestSchema>;
export type UnloadSubtypesConeRequest = z.infer<typeof UnloadSubtypesConeRequestSchema>;
...
export type GetSpecializationHierarchyRequest = z.infer<typeof GetSpecializationHierarchyRequestSchema>;
export type StandardResponse = z.infer<typeof StandardResponseSchema>;

// Action type union
export type PortalUserActionType = typeof PortalUserActions[keyof typeof PortalUserActions];