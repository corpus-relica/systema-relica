...
interface SubtypesDialogueProps {
  uid: number;
  subtypes: Array<Fact>;
...
const SubtypesDialogue: React.FC<SubtypesDialogueProps> = ({
  uid,
  subtypes,
  existingSubtypes,
  handleClose,
  ...
  return (
    <Dialog open={true}>
      <DialogTitle>Show/Hide Subtypes</DialogTitle>
      <DialogContent>
        <DialogContentText>
          select which subtype kinds to show/hide
        </DialogContentText>
...
export default SubtypesDialogue;
