...
-- Legacy tables that might be removed later
...
-- Updated environments table with bytea fields
CREATE TABLE public.environments (
    id serial4 NOT NULL,
    name varchar(255) NULL,
    selected_entity_id int8 NULL,
    selected_entity_type entity_fact_enum NULL,
...
CREATE INDEX idx_environments_updated ON public.environments USING btree (updated_at);

-- User-environments join table
...
-- Password hash for 'admin123' using bcrypt (you would replace this with your actual hashing method)
INSERT INTO public.users (
    ...
    'admin',
    'admin@example.com',
    '$2y$10$BMxWgRIqnJBSBpid8paoxOmHVxsa7tloCr9Zj6JdgVqlfVd/3RDRO', -- Hash for 'admin123'
    'System',
    'Administrator',
    true,
    true
